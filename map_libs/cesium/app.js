Cesium.Ion.defaultAccessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI0NGExYjJiMC1iMWI4LTQxZmYtOWQ3Yi1kNGRhZmIxMzc1NjciLCJpZCI6ODg4LCJpYXQiOjE2NzE2Mjg3MjJ9.sHXG04RRdVzBT4uBz60aFCiksRk57v_MbKVbhAQQGxk";
...
let mapboxButton = (document.getElementById("mapbox").onclick = () => {
  ...
  let MAPBOX_ACCESS_TOKEN =
    "pk.eyJ1Ijoic2VsYWhhdHRpbiIsImEiOiJjbGJ4anh4NDgwN3BwM25ybWwzbG9sdDJpIn0.GjNP1CgfPTcojfCI95vsCA";
  ...
  let customImageryProvider = new Cesium.UrlTemplateImageryProvider({
    url: url,
  });
